...
$DestinationDirectory	= '../images/feature/'; //Upload Directory ends with / (slash)
$Quality 				= 100;
...
//					echo '</table>';
					...
					$sql = "update ".$table." set ThumbName = '$thumb_DestRandImageName', path = '$DestRandImageName'  where id = '$id'";
