		    ...
		    if($id == 3)
			{
			   ...
			   <div class="alert alert-danger alert-dismissable">
                      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                       FQAs Name Already Exists.
               </div>
							
		<?php } ?>
        
        <div class="bg"> 
          <h2 class="sub-header">All FAQs</h2><div class="newpage"><a href="faqadd.php">Add FQA</a></div>
            ...
            <table class="table table-striped" id="rounded-corner">
			  ...
			  ?>
                <tr>
                  ...
                  <td><a href="faqEdit.php?id=<?php echo $row['id']; ?>" title="Edit"><i class="fa fa-pencil-square-o"></i></a></td>
                  <td><a href="delete.php?row=<?php echo $row['id']; ?>&tbl=faq" class="ask" title="Delete"><img src="images/trash.png"></a></td>
                </tr>
