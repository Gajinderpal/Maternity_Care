...
$DestinationDirectory	= '../images/product/'; //Upload Directory ends with / (slash)
$Quality 				= 100;
...
//					echo '</table>';
					...
					$sql = "INSERT INTO media (path, ThumbName, ImgPath, product, name) VALUES ('$DestRandImageName', '$thumb_DestRandImageName', '$ImageName' , '$product',  '$ImageName[$i]');";
